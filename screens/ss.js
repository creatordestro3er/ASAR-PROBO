...
const liveMatches = [
    { id: '1', title: 'SA vs ENG', image: require('../assets/SA.png') },
    { id: '2', title: 'ENG vs IND', image: require('../assets/ind.png') },
    { id: '3', title: 'AUS vs NZ', image: require('../assets/aus.jpg') },
    { id: '4', title: 'PAK vs SA', image: require('../assets/pak.png') },
    { id: '5', title: 'SL vs BAN', image: require('../assets/sri.jpg') },
  ];
  
  const randomMatches = [
    { id: '6', title: 'Jack Horrocks to score 10 or more run vs Sweden', image: require('../assets/cricket.png') },
    { id: '7', title: 'Sweden to take 9 or more wckets at the end of 20 overs vs Gibraltar', image: require('../assets/cricket.png') },
    { id: '8', title: 'Kohli to hit 6 in the next bowl', image: require('../assets/cricket.png') },
    { id: '9', title: 'who will win IND Vs Pak', image: require('../assets/cricket.png') },
  ];
