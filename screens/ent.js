...
const liveMatches = [
    { id: '1', title: 'Honey Singh New Updates', image: require('../assets/cinema.jpg') },
    { id: '2', title: 'GOT new Season Live!', image: require('../assets/cinema.jpg') },
    { id: '3', title: 'Modi live Speech', image: require('../assets/cinema.jpg') },
   
  ];
  
  const randomMatches = [
    { id: '6', title: 'Bad News(formerly Mere Mehboob Mere Sanam) to have a higher 1st week box office collection(India)', image: require('../assets/cricket.png') },
    { id: '7', title: 'kalki Movie to earn 10 Crores or more domestic box office collection on july 20', image: require('../assets/cricket.png') },
    { id: '8', title: 'Auron Mein Kahan Dum Tha movie to earn 8 crores or more domestic box offoce', image: require('../assets/cricket.png') },
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        ...
        <Text style={styles.sectionTitle}>Everything on latest movie collections. Reality Shows and music</Text>
        <View style={styles.box}>
          {renderLiveMatches()}
          <Slider
            style={styles.slider}
