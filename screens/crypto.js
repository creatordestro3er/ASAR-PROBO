...
const liveMatches = [
  { id: '1', title: 'Bitcoin', image: require('../assets/crypto.png') },
  { id: '2', title: 'Bitcoin daily', image: require('../assets/crypto.png') },
  { id: '3', title: 'Etherium', image: require('../assets/et.png') },
];

const randomMatches = [
  { id: '6', title: 'Etherium to be priced at 3186.00 USDT or more at 06:25 PM?', image: require('../assets/cricket.png') },
  { id: '7', title: 'Bitcoin to be priced at 58717.02 USDT or more at 6:25 PM?', image: require('../assets/cricket.png') },
  { id: '8', title: 'Bitcoin to be priced at 4567.00 USDT or more at 7:00 PM?', image: require('../assets/cricket.png') },
];
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.sectionTitle}>Live Trade</Text>
        <View style={styles.box}>
          {renderLiveMatches()}
          <Slider
            style={styles.slider}
